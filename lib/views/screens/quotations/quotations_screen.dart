...
class _QuotationsScreenState extends State<QuotationsScreen> {
  ...
  Future<void> _openCompanyPicker() async {
    ...
    try {
      ...
      await context.read<QuotationsController>().refresh();
    } catch (_) {
      if (!mounted) return;
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        final bool showRefreshingBar =
            ctrl.isLoading && ctrl.quotations.isNotEmpty;
            ...
            child: RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemCount: () {
                  ...
                  if (ctrl.visibleQuotations.isEmpty &&
                  ...
                  if (ctrl.visibleQuotations.isEmpty) return headerCount + 1;
                  return headerCount + ctrl.visibleQuotations.length;
                }(),
                itemBuilder: (BuildContext context, int index) {
                  ...
                  final Quotation q = ctrl.visibleQuotations[i];
                    ...
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute<void>(
                          builder: (_) => QuotationDetailsScreen(quotation: q),
                        ),
                      );
                    },
                  );
